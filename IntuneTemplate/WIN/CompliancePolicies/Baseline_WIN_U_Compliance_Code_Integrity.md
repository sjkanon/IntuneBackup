...
| Bron | OpenIntuneBaseline Windows v4.0 — CP - Device Health - U - Code Integrity |
| Bestand | [`Baseline_WIN_U_Compliance_Code_Integrity.json`](Baseline_WIN_U_Compliance_Code_Integrity.json) |
