...
Toetst of Microsoft Defender aanstaat en de beveiligingsinformatie actueel is.
...
| Bron | OpenIntuneBaseline Windows v4.0 — CP - Defender - U - Security Intelligence |
| Bestand | [`Baseline_WIN_U_Compliance_Defender_Security_Intelligence.json`](Baseline_WIN_U_Compliance_Defender_Security_Intelligence.json) |
